...
{
    internal static class MoonCalculations
    {
        public static MoonCoordinates moonCoords(double d)
        {
            ...
            {
                ra = PositionCalculations.rightAscension(l, b),
                dec = PositionCalculations.declination(l, b),
                dist = dt
            };
        }
